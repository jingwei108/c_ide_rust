...
class PanelItem {
  ...
  static const linkedListVis = PanelItem._(id: 'linkedListVis', label: '链表可视化', icon: Icons.linear_scale);
  static const treeVis = PanelItem._(id: 'treeVis', label: '树可视化', icon: Icons.account_tree);
