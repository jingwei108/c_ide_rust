...
- **覆盖**：298 个 Baseline 用例 + 82 个模板生成用例 + 76 个 K&R 用例 + 92 个 LeetCode 题（C Shadow Verification 合计 562 个用例，555 匹配）；83 个 C++ 用例（C++ Shadow Verification，83/83 全绿；2026-06-18 实测）
