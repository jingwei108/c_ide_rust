...
- **覆盖**：304 个 Baseline 用例 + 82 个模板生成用例 + 76 个 K&R 用例 + 92 个 LeetCode 题（C Shadow Verification 合计 568 个用例，564 匹配；统计口径含 match + cide_better + known_issue）；83 个 C++ 用例（C++ Shadow Verification，83/83 全绿；2026-06-25 实测）
