...
- **覆盖**：298 个 Baseline 用例 + 82 个模板生成用例 + 69 个 K&R 用例 + 48 个 LeetCode 简单题（C Shadow Verification 合计 511 个用例，504 匹配）；83 个 C++ 用例（C++ Shadow Verification，83/83 全绿；2026-06-16 实测）
