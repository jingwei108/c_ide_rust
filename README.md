...
- **C 子集**：覆盖教学场景常用语法，Shadow Verification 562 用例 / 556 匹配（2026-06-18 实测）
...
2. **K&R + LeetCode 真实程序回归**：K&R 69 题、LeetCode 92 题
...
- C Shadow Verification：**562 用例，556 匹配**（差异均为诚实记录的已知限制；2026-06-18 实测）
