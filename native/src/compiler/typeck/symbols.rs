use crate::compiler::ast::{AccessSpec, Param, TemplateParam, Templateable, Type, VTable};
...
pub(crate) struct LambdaInfo {
    ...
    pub(crate) body: crate::compiler::ast::Stmt,
    pub(crate) loc: crate::compiler::ast::SourceLoc,
}
