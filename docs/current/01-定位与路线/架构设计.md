...
**堆**：2026-09-11 决议改为 **bump 分配 + 有界隔离（quarantine）**，把 churn 与 leak 分离，配合"三道墙"（步数保险丝 / 调用深度上限 / region 表封顶）保证教学场景下的内存行为有界且可解释——见 [`堆有界隔离决议.md`](../../06-出口与协议。
...
设计细节与消费方契约见 [`统一模式设计.md`](../../05-教学体验；
为什么这套体验本身是竞争力见 [`VM教学体验优势.md`](../../05-教学体验。
...
路线与设计见 [`认知推理系统设计.md`](../../05-教学体验、[`算法与数据结构教学设计.md`](../../05-教学体验。
...
模板源与教材算法清单见 [`模板维护指南.md`](../../05-教学体验、[`ARCHIVE_数据结构模板路线图.md`](../../archive/ARCHIVE_数据结构模板路线图.md。
...
capi 分批落地进度与签名评审依据见 [`CAPI评审回复与实现状态.md`](../../06-出口与协议；
serve 方法与协议契约见 [`CLI使用手册.md`](../../02-构建与上手 §6。
