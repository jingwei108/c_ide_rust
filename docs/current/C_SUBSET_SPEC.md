...
依据 [`CIDE_HEAP_QUARANTINE_DECISION.md`](CIDE_HEAP_QUARANTINE_DECISION.md)（ASAN quarantine 原版机制）：
...
| include 环检测 | 依赖图静态 DFS，A↔B 互包含报 E1015 并跳过该 include |
...
| 展开保险丝 | 深度 64 + 累计产出 262144 token 双预算，超限 E1017 |
